...
appenginesdk: directories
	wget -c https://commondatastorage.googleapis.com/appengine-sdks/featured/google_appengine_$(version).zip -O /tmp/google_appengine_$(version).zip
...
libraries: requirements appenginesdk
	...
	ln -sv $(CURDIR)/lib/google_appengine/*.py $(CURDIR)/$(VENV)/bin/
	...
	echo "$(CURDIR)/lib/google_appengine/" >> $(CURDIR)/$(VENV)/lib/python2.7/site-packages/gae.pth
